                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-sm-6 col-md-4 col-lg-4">
                                          ...
                                          <div>
                                              ...
                                              <div class="form-check pl-4" style="left: 0px; top: 0px; height: 36px">
                                                  <asp:CheckBox ID="cbIsActive" runat="server" Text="&nbsp; IsActive"
                                                      CssClass="form-check-input" />
                                              </div>

                                              <div class="pb-5">
                                                  <asp:Button ID="dtnAddOrUpdate" runat="server" Text="Add" CssClass="btn btn-primary" 
                                                      OnClick="dtnAddOrUpdate_Click1" />

                                                  &nbsp;
                                                  <asp:Button ID="btnClear" runat="server" Text="Clear" CssClass="btn btn-primary"
                                                      CausesValidation="false" OnClick="btnClear_Click" style="margin-top: 0" />
                                              </div>
                                              <div>
