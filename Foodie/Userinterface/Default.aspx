<%@ Page Title="" Language="C#" MasterPageFile="~/Userinterface/Userinterface.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Foodie.Userinterface.Default" %>
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="../Templates/images/o1.jpg" alt="">
              </div>
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="../Templates/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
